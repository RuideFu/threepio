...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stripchart_dynamic_scale_checkbox = QtWidgets.QCheckBox(self.stripchart_control_group)
        self.stripchart_dynamic_scale_checkbox.setChecked(True)
        self.stripchart_dynamic_scale_checkbox.setObjectName("stripchart_dynamic_scale_checkbox")
        self.horizontalLayout_4.addWidget(self.stripchart_dynamic_scale_checkbox)
        self.stripchart_max_voltage_slider = QtWidgets.QSlider(self.stripchart_control_group)
        self.stripchart_max_voltage_slider.setMinimum(1)
        self.stripchart_max_voltage_slider.setMaximum(15)
        self.stripchart_max_voltage_slider.setProperty("value", 5)
        self.stripchart_max_voltage_slider.setOrientation(QtCore.Qt.Horizontal)
        self.stripchart_max_voltage_slider.setTickPosition(QtWidgets.QSlider.TicksBelow)
        self.stripchart_max_voltage_slider.setTickInterval(1)
        self.stripchart_max_voltage_slider.setObjectName("stripchart_max_voltage_slider")
        self.horizontalLayout_4.addWidget(self.stripchart_max_voltage_slider)
        self.stripchart_max_voltage_value_label = QtWidgets.QLabel(self.stripchart_control_group)
        self.stripchart_max_voltage_value_label.setObjectName("stripchart_max_voltage_value_label")
        self.horizontalLayout_4.addWidget(self.stripchart_max_voltage_value_label)
        self.gridLayout_4.addLayout(self.horizontalLayout_4, 1, 0, 1, 4)
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.stripchart_grid_checkbox = QtWidgets.QCheckBox(self.stripchart_control_group)
        self.stripchart_grid_checkbox.setObjectName("stripchart_grid_checkbox")
        self.horizontalLayout_5.addWidget(self.stripchart_grid_checkbox)
        self.stripchart_grid_sparser_label = QtWidgets.QLabel(self.stripchart_control_group)
        self.stripchart_grid_sparser_label.setObjectName("stripchart_grid_sparser_label")
        self.horizontalLayout_5.addWidget(self.stripchart_grid_sparser_label)
        self.stripchart_grid_density_slider = QtWidgets.QSlider(self.stripchart_control_group)
        self.stripchart_grid_density_slider.setMinimum(2)
        self.stripchart_grid_density_slider.setMaximum(24)
        self.stripchart_grid_density_slider.setProperty("value", 8)
        self.stripchart_grid_density_slider.setOrientation(QtCore.Qt.Horizontal)
        self.stripchart_grid_density_slider.setTickPosition(QtWidgets.QSlider.TicksBelow)
        self.stripchart_grid_density_slider.setTickInterval(1)
        self.stripchart_grid_density_slider.setObjectName("stripchart_grid_density_slider")
        self.horizontalLayout_5.addWidget(self.stripchart_grid_density_slider)
        self.stripchart_grid_denser_label = QtWidgets.QLabel(self.stripchart_control_group)
        self.stripchart_grid_denser_label.setObjectName("stripchart_grid_denser_label")
        self.horizontalLayout_5.addWidget(self.stripchart_grid_denser_label)
        self.gridLayout_4.addLayout(self.horizontalLayout_5, 2, 0, 1, 4)
        ...
        self.actionRA = QtGui.QAction(MainWindow)
        self.actionRA.setObjectName("actionRA")
        self.actionDec = QtGui.QAction(MainWindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.stripchart_dynamic_scale_checkbox.setText(_translate("MainWindow", "Dynamic Scale"))
        self.stripchart_max_voltage_value_label.setText(_translate("MainWindow", "5V"))
        self.stripchart_grid_checkbox.setText(_translate("MainWindow", "Grid"))
        self.stripchart_grid_sparser_label.setText(_translate("MainWindow", "Sparser"))
        self.stripchart_grid_denser_label.setText(_translate("MainWindow", "Denser"))
